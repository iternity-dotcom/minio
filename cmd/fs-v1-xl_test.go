...
func TestFSXLParentDirIsObject(t *testing.T) {
...
// TestNewFSXL - tests initialization of all input disks
// and constructs a valid `FS` object layer.
func TestNewFSXL(t *testing.T) {
...
// TestFSXLGetBucketInfo - test GetBucketInfo with healty and faulty disks
func TestFSXLGetBucketInfo(t *testing.T) {
	// Prepare for testing
	disk := filepath.Join(globalTestTmpDir, "minio-"+nextSuffix())
	defer os.RemoveAll(disk)
...
func TestFSXLPutObject(t *testing.T) {
	// Prepare for tests
	disk := filepath.Join(globalTestTmpDir, "minio-"+nextSuffix())
	defer os.RemoveAll(disk)
...
// TestFSXLDeleteObject - test fs.DeleteObject() with healthy and corrupted disks
func TestFSXLDeleteObject(t *testing.T) {
	// Prepare for tests
	disk := filepath.Join(globalTestTmpDir, "minio-"+nextSuffix())
	defer os.RemoveAll(disk)
...
// TestFSXLDeleteBucket - tests for fs DeleteBucket
func TestFSXLDeleteBucket(t *testing.T) {
	// Prepare for testing
	disk := filepath.Join(globalTestTmpDir, "minio-"+nextSuffix())
	defer os.RemoveAll(disk)
...
// TestFSXLListBuckets - tests for fs ListBuckets
func TestFSXLListBuckets(t *testing.T) {
	// Prepare for tests
	disk := filepath.Join(globalTestTmpDir, "minio-"+nextSuffix())
	defer os.RemoveAll(disk)
...
// TestFSXLHealObject - tests for fs HealObject
func TestFSXLHealObject(t *testing.T) {
	disk := filepath.Join(globalTestTmpDir, "minio-"+nextSuffix())
	defer os.RemoveAll(disk)
...
func TestFSXLHealObjects(t *testing.T) {
	disk := filepath.Join(globalTestTmpDir, "minio-"+nextSuffix())
	defer os.RemoveAll(disk)
