...
var erasureEncodeTests = []struct {
	...
	{dataBlocks: 1, onDisks: 1, offDisks: 0, blocksize: int64(blockSizeV1), data: oneMiByte, offset: 0, algorithm: DefaultBitrotAlgorithm, shouldFail: false, shouldFailQuorum: false},                 // 0
