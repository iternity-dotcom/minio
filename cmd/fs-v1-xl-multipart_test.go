...
func TestFSXLCleanupMultipartUploadsInRoutine(t *testing.T) {
	// Prepare for tests
...
// TestFSXLNewMultipartUploadFaultyDisk - test NewMultipartUpload with faulty disks
func TestFSXLNewMultipartUploadFaultyDisk(t *testing.T) {
	// Prepare for tests
	disk := filepath.Join(globalTestTmpDir, "minio-"+nextSuffix())
	defer os.RemoveAll(disk)
	obj := initFSXLObjects(disk, t)
...
// TestFSXLPutObjectPartFaultyDisk - test PutObjectPart with faulty disks
func TestFSXLPutObjectPartFaultyDisk(t *testing.T) {
	// Prepare for tests
	disk := filepath.Join(globalTestTmpDir, "minio-"+nextSuffix())
	defer os.RemoveAll(disk)
	obj := initFSXLObjects(disk, t)
...
// TestFSXLCompleteMultipartUploadFaultyDisk - test CompleteMultipartUpload with faulty disks
func TestFSXLCompleteMultipartUploadFaultyDisk(t *testing.T) {
	// Prepare for tests
	disk := filepath.Join(globalTestTmpDir, "minio-"+nextSuffix())
	defer os.RemoveAll(disk)
	obj := initFSXLObjects(disk, t)
...
// TestFSXLCompleteMultipartUpload - test CompleteMultipartUpload
func TestFSXLCompleteMultipartUpload(t *testing.T) {
	// Prepare for tests
	disk := filepath.Join(globalTestTmpDir, "minio-"+nextSuffix())
	defer os.RemoveAll(disk)
	obj := initFSXLObjects(disk, t)
...
// TestFSXLCompleteMultipartUpload - test CompleteMultipartUpload
func TestFSXLAbortMultipartUpload(t *testing.T) {
...
// TestFSXLListMultipartUploadsFaultyDisk - test ListMultipartUploads with faulty disks
func TestFSXLListMultipartUploadsFaultyDisk(t *testing.T) {
	// Prepare for tests
	disk := filepath.Join(globalTestTmpDir, "minio-"+nextSuffix())
	defer os.RemoveAll(disk)
